...
subplot(211), plot(W, angle(x), '.'), title('DFT em ângulo');
...
figure(3), subplot(212), stem(W, abs(cm)), title('cm em módulo');

subplot(211), plot(W, angle(cm), '.'), title('cm em ângulo');
...
title('Sinal reconstruído a partir dos coeficientes');